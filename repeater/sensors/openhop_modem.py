    ...
    _settings_schema = [
        {
            ...
            "label": "Host",
            "default": "",
            "help": "Modem hostname or IP address",
        },
        {
            "key": "port",
            "type": "integer",
            "label": "Port",
            "default": 80,
            "help": "Modem HTTP API port (not the radio TCP port)",
        },
        {
            "key": "scheme",
            "type": "string",
        ...
        },
        {
            ...
            "label": "Password",
            "default": "",
            "help": "Basic auth password (not stored in API responses)",
        },
        {
