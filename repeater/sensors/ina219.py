    ...
    _settings_schema = [
        {
            ...
            "label": "I2C Address",
            "default": "0x40",
            "help": "Hex I2C address (e.g. 0x40, 0x41, 0x44, 0x45)",
        },
        {
            "key": "bus_number",
            "type": "integer",
        ...
        {
            "key": "max_expected_amps",
            "type": "number",
            "label": "Max Expected Amps",
            "default": 2.0,
            "help": "Maximum expected current for calibration",
        },
        {
            "key": "shunt_ohms",
            "type": "number",
            "label": "Shunt Resistor (Ω)",
            "default": 0.1,
            "help": "Shunt resistor value in ohms",
        },
    ]
